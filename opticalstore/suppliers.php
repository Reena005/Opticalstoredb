...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_manufacturer'])) {
    ...
    if ($name) {
        $query = "INSERT INTO manufacturer (name, contact_info) VALUES ($1, $2)";
...
// Fetch all manufacturers for listing
$manufacturers_result = pg_query($conn, "SELECT * FROM manufacturer ");
?>
